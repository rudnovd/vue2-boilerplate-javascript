<template>
  <UserLayout>
    <section class="objects">
      ...
      <section v-if="!state.isLoading && !state.error" class="objects-list">
        <SingleObject v-for="object in objects" :key="object.id" :text="object.name" @click="openObject(object.id)" />
      </section>
    </section>
  </UserLayout>
</template>
